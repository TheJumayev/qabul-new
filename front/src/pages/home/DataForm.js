                              ...
                              <div>
                                ...
                                {(activeField === "passportNumber" || activeField === "passportPin") && (
                                  <div className="mt-6 animate-fadeIn">
                                    <div className="mx-auto max-w-3xl bg-blue-50 rounded-xl p-4 shadow-sm border border-blue-100">
                                    ...
                                    {formData.getContract ? (
                                      ...
                                      <div>
                                        ...
                                        <h4 className="mt-2 font-medium">
                                          Manzil: Buxoro shahri Sitorayi
                                          Mohi-Xosa MFY G'ijduvon ko'chasi
                                          250-uy
                                        </h4>
                              ...
                              {formData.getContract ? (
                                ...
                                <div>
                                  <h3 className="font-medium text-3xl">
                                    Imtihon topshirish hamda hujjatlaringizni
                                    taqdim etish uchun sizdan
                                    universitetimizning markaziy binosiga
                                    tashrif buyurishingiz so'raladi.
                                  </h3>
                                  <h4 className="mt-2 font-medium">
